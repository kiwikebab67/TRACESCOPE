...
const NetworkWaterfall = ({ packets }) => {
  ...
  return (
    <div className="w-full h-full absolute inset-0 bg-[#020617] text-white overflow-hidden flex items-center justify-center">
      <div className="absolute inset-0 bg-gradient-to-b from-transparent to-[#020617] pointer-events-none z-10" />
